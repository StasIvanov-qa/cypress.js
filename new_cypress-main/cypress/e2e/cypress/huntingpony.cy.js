describe('Тестирование покупки товаров', function () {
    it('Тестирование покупки товара', function () {
       ...
       cy.get('.add-cart-counter__btn').wait(4000).click();
       cy.get('[data-add-cart-counter-plus=""]').click();
       cy.get('.header__cart > .icon').click();
       cy.contains('Оформить заказ')
       cy.get('.cart-controls > .button')
    })
})